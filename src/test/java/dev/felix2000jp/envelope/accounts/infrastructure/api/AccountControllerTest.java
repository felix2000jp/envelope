...
class AccountControllerTest {
    ...
    void get_then_return_200_and_accounts() throws Exception {
        ...
        var expectedResponse = jsonMapper.writeValueAsString(accountListDto);
    ...
    void update_then_return_200_and_updated_account(String name, BigDecimal balance) throws Exception {
        ...
        var expectedResponse = jsonMapper.writeValueAsString(updatedAccountDto);
        var requestBody = jsonMapper.writeValueAsString(updateAccountDto);
    ...
    void getAccountById_then_return_200_and_account() throws Exception {
        var expectedResponse = jsonMapper.writeValueAsString(accountDto);
    ...
    void addTransaction_then_return_201_and_updated_account() throws Exception {
        ...
        var requestBody = jsonMapper.writeValueAsString(addTransactionDto);
        var expectedResponse = jsonMapper.writeValueAsString(newTransactionDto);
    ...
    void addTransaction_given_invalid_request_then_return_400(AddTransactionDto invalidDto) throws Exception {
        var requestBody = jsonMapper.writeValueAsString(invalidDto);
    ...
    void updateTransaction_then_return_200_and_updated_account() throws Exception {
        ...
        var requestBody = jsonMapper.writeValueAsString(updateTransactionDto);
        var expectedResponse = jsonMapper.writeValueAsString(updatedTransactionDto);
